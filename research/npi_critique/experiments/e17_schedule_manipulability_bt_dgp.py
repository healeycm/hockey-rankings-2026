...
Run from the project root as a module:
    python -m research.npi_critique.experiments.e17_schedule_manipulability_bt_dgp
"""
import numpy as np
import pandas as pd
...
from research.npi_critique.harness.simulate import assign_true_strengths, simulate_season_bradley_terry, true_ranking, games_played
...
def main():
    ...
    for rep in range(N_REPLICATIONS):
        ...
        for lo, hi in PERCENTILE_BANDS:
            ...
            sim = simulate_season_bradley_terry(sched_variant, strengths, rng)
            models = fit_all(sim)
    ...
    results.to_csv(results_path("e17_schedule_manipulability_bt_dgp", "results.csv"), index=False)

...
~1.7x) survive under simulate_season_mixed() instead of
...
Run from the project root as a module:
    python -m research.npi_critique.experiments.e21_connectivity_dgp_c
"""
import numpy as np
import pandas as pd
...
from research.npi_critique.harness.simulate import assign_true_strengths, simulate_season_mixed, games_played
...
def main():
    ...
    for rep in range(N_REPLICATIONS):
        ...
        sim_baseline = simulate_season_mixed(schedule, strengths, rng)
    ...
    extreme_df.to_csv(results_path("e21_connectivity_dgp_c", "extreme_team_ratings.csv"), index=False)
    collateral_df.to_csv(results_path("e21_connectivity_dgp_c", "collateral_distortion.csv"), index=False)
